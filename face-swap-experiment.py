...
img = cv2.imread("img/jack-black.jpg")
...
face = faces[0]  # Use first face from first image
face2 = faces2[0]  # Use first face from second image
...
# Create a mask for the destination face area
...
# Blend the new face with the original image
...
# Find the center of the face mask for seamless cloning
